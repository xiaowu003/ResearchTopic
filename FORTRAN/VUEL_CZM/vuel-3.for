      ...
      contains
       subroutine vector_cross( vec1, vec2 , cross) 
         ...
         cross(3) = vec1(1)*vec2(2) - vec1(2)*vec2(1)!��������������ֵsimon 2011-11-1
         return
...
c*****************************************************************************80
      ...
      !
      !! use system_constant   !use system_constant������implicit noneǰ��
      include 'vaba_param.inc'
     ...
     *           normal,area,fc)  !! gpos, Hpos, fcount                                                                                                                                                                
      ...
      tGap = sqrt( tGapVect(1)*tGapVect(1)+tGapVect(2)*tGapVect(2)+tGapVect(3)*tGapVect(3) ) !! �������ֵ                                                                                                                                                        
     ...
     *     m_deltaSo,tGap,nGap,deltai,deltaf) !! �����������ε�����λ��                                                                                                                                                     
      if(effDelta>=deltaf)then !failure of the gauss point.                                                                                                                                                                                                       
        ...
        !call obtain_failure_values_of_gauss_integration_points(co_eid,ith,ghis=ghis) !! ghis��Ч�ſ�������ʷ���ֵ                                                                                                                                             
     ...
     * delta,det_ndelta,det_tdelta,eff_delta,ghis,nvect,tvect,sig)                                                                                                                                                                                
      ...
      if(ghis<=0.0) goto 111  !! !! ghis��Ч�ſ�������ʷ���ֵ                                                                                                                                                                                                 
      !end if                                                                                                                                                                                                                                                      
...
!============================================================================
     ...
     * delta1f,delta2f,gaussPara)
       ...
       dimension props(8),rknt(2),strength(2),gaussPara(2,4)
         ...
         delta10=strenthN/rkn                         !! �����ʼ���˷�����
         delta20=strenthT/rkt                         !! �����ʼ���˷�����  
         delta1f=two*Gnc/strenthN                     !! ������ȫ���˷�����
         delta2f=two*Gtc/strenthT                     !! ������ȫ���˷�����
...
c
     ...
     *    lflags(iProcedure).eq.jDynExplicit) then  
          ...
          call key_parameter(props,constant,rkn,rkt,strenthN,          !! ������ֵ
     ...
     *             jIntForceAndDtStable) then  
           ...
           do kblock = 1, nblock
               call seperation_and_middle_suface(u,coords,disNode,nGP, !! �����������������Լ�ÿ�Խڵ�ķֿ���
     *            kblock,nblock,ndofel,ncrd,nnode,uRelative,xyzMidsurf)
               ...
               call shape_q4(gaussPara(1,iGp), gaussPara(2,iGp), !! ���κ�������ƫ��
     *                           rShape, drds, drdt)
               call normal_seperation_and_shear_seperation_and_unitVect
     *                   (drds,drdt,xyzMidsurf,rShape,uRelative,
     *                   vNormalMod,vNormal,shearUnit,uRelaLocal)      !! ��λ�������͵�λ���������з�������� l
     ...
     *            Gtc,exp,delta2f,delta1f,rkn,OldSDEG,SDEG,tau,strength)
               ...
               if ( SDEG >= 1.0d0 ) then 
                   ...
                   stop
                    ...
                    rNormaTauVect=tau(1)*vNormal                       !! ����Ӧ������
                    rShearTauVect=tau(2)*shearUnit                     !! ����Ӧ������
                    rTauVect=rNormaTauVect+rShearTauVect               !! ��Ӧ������
                    !!  �ɻ��ֵ�Ӧ����ֵ�õ��ڵ��� 
                    do i=1,nGP
